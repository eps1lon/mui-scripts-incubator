		...
		test("keyboard navigation when horizontal", async () => {
			...
			await expect(async () => {
				page.keyboard.press("Home");
						...
						"0"
						"Administrator: C:\\\\actions\\\\runner-provisioner-Windows\\\\provisioner.exe, terminal, blank"
						"Untitled - Chromium"
						"Address and search bar, edit, has auto complete, Ctrl+L, about:blank"
						"deploy-preview-24187--material-ui.netlify.app/components/slider/?nvda-reset=3qq65up9o43 selected"
					`);
		}, 30000);
