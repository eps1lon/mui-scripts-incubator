...
describe("nvda", () => {
	...
	test("settings drawer", async () => {
		...
		await expect(async () => {
			...
			`"Settings, heading, level 5,  , button,  , separator, Mode, Mode, grouping, light, toggle button, not pressed, system, toggle button, pressed, dark, toggle button, not pressed, out of grouping, Direction, Direction, grouping, light, toggle button, pressed, system, toggle button, not pressed, out of grouping, Color, Edit website colors"`
		);
