		...
		test("keyboard navigation when vertical", async () => {
			...
			await expect(async () => {
				await $slider.focus();
						...
						"React Slider component - Material-UI - Chromium"
						"tool bar"
						"Address and search bar, edit, has auto complete, Ctrl+L, selected https://deploy-preview-25526--material-ui.netlify.app/components/slider/?nvda-reset=hbbfwtcb659"
