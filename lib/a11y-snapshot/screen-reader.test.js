	...
	test("quick access to the docs search", async () => {
		...
		await expect(async () => {
			await page.keyboard.press("Control+k");
					...
					"React Box component - Material-UI - Chromium"
					"tool bar"
					"Address and search bar, edit, has auto complete, Ctrl+L, https://deploy-preview-26175--material-ui.netlify.app/components/box/?nvda-reset=e582g9ftflo"
