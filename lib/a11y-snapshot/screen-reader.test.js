		...
		test("keyboard navigation when horizontal", async () => {
			...
			await expect(async () => {
				await $slider.focus();
						...
						"main landmark, led slider"
						"slider, unavailable, 30"
						"heading, level 2, clickable"
						"heading, level 2, Discrete sliders"
			...
			}).toMatchSpeechInlineSnapshot(`"React Slider component - Material-UI"`);

			await expect(async () => {
				page.keyboard.press("ArrowUp");
			}).toMatchSpeechInlineSnapshot(`
						"By order , main landmark, led slider"
						"slider, unavailable, 30"
						"heading, level 2, clickable"
						"heading, level 2, Discrete sliders"
						"Discrete sliders can be adjusted to a specific value by referencing its value indicator. "
			...
			await expect(async () => {
				...
				`"https://deploy-preview-24638--material-ui.netlify.app/components/slider/?nvda-reset=av1lv2epznu selected"`
			);
