...
describe("nvda", () => {
	...
	describe("TimePicker", () => {
		test("keyboard navigation for desktop variant", async () => {
			...
			await expect(() => page.keyboard.press("ArrowUp"))
				.toMatchSpeechInlineSnapshot(`
						"Select hours. Selected time is 1:00 AM"
						"Choose time, selected time is 1:00 AM"
						"Select hours. Selected time is 1:00 AM"
					`);

			await expect(() => page.keyboard.press("ArrowDown"))
				.toMatchSpeechInlineSnapshot(`
			...
			await expect(() => page.keyboard.press("End"))
				.toMatchSpeechInlineSnapshot(`
						"Select hours. Selected time is 11:00 AM"
						"Choose time, selected time is 11:00 AM"
						"Select hours. Selected time is 11:00 AM"
					`);

			await expect(() => page.keyboard.press("Home"))
				.toMatchSpeechInlineSnapshot(`
						"Select hours. Selected time is 12:00 AM"
						"Choose time, selected time is 12:00 AM"
						"Select hours. Selected time is 12:00 AM"
